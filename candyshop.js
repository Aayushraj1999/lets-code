async function saveToLocalStorage(event) {
    ...
    try {
      const postData = await axios.post("https://crudcrud.com/api/288c473ab74e40b7ae36f03134715cd4/CandyShop",obj);
  ...
  window.addEventListener("DOMContentLoaded", async () => {
    try {
      const windowData = await axios.get("https://crudcrud.com/api/288c473ab74e40b7ae36f03134715cd4/CandyShop");
      ...
      if (obj.quantity >= 1) {
        try {
          const dataChange = await axios.put(
            `https://crudcrud.com/api/288c473ab74e40b7ae36f03134715cd4/CandyShop/${obj._id}`,
            {
              candy: `${obj.candy}`,
      ...
      if (obj.quantity >= 2) {
        try {
          const dataChange2 = await axios.put(
            `https://crudcrud.com/api/288c473ab74e40b7ae36f03134715cd4/${obj._id}`,
            {
              candy: `${obj.candy}`,
              description: `${obj.description}`,
              price: `${obj.price}`,
